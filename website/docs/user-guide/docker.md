...
- Node.js packages needed by Hermes. Playwright/Chromium is not bundled because browser automation is optional and its download must not delay image publication.
